                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                                    ...
                                    <div className="pe-4">
                                        <div className="cropped">
                                            <Image src="/img/Thumbnail-3.png" width={200} height={130}
                                                className="img-fluid" alt="Game Thumbnail" />
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="payment pt-10 pb-10">
                                ...
                                <Row label="Your Account Name"  value="Masayoshi Angga" />
                                <Row label="Type"  value="Worldwide Transfer" />
                                <Row label="Bank Name"  value="PT Store GG" />
                                <Row label="Bank Number"  value="1800-1800-1800" />
                            </div>
